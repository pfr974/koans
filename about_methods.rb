...
class AboutMethods < Neo::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    ...
    assert_match(/wrong number of arguments \(given 0, expected 2\)/,
     exception.message)

    exception = assert_raise(ArgumentError) do
      my_global_method(1,2,3)
    end
    assert_match(/wrong number of arguments \(given 3, expected 2\)/,
     exception.message)
  end
  ...
  # By default, the last line will be returned unless of an exlicit return
